...
| **Registry → Lifecycle** | Nếu `kind: event`: `registry.effective_from.event_ref.sequence ≤ cursor.lifecycle_frontier.position.sequence`. Nếu `kind: genesis`: registry phải là Genesis Registry (§8.3.1) |
