...
- Risk Classification bắt buộc, ngay sau Review A — đúng một trong R0/R1/R2 (định nghĩa đầy đủ: trước `ADR-045` activate, tại [ADR-042](../adr/ADR-042.md); sau `ADR-045` activate, nguồn định nghĩa hiện tại LÀ [`ADR-045`](../adr/ADR-045.md), tự chứa đầy đủ, KHÔNG đổi substance — `v2.4 candidate`); R0/R1 mặc định `NO CROSS-CHECK`; R2: Review A recommend optional cross-check, KHÔNG BAO GIỜ tự động yêu cầu, Product Owner chọn `CROSS-CHECK` hoặc `PROCEED WITHOUT CROSS-CHECK`;
...
- Risk Classification present và resolve đúng một trong R0/R1/R2 (định nghĩa: trước `ADR-045` activate, tại [ADR-042](../adr/ADR-042.md); sau `ADR-045` activate, tại [`ADR-045`](../adr/ADR-045.md) — `v2.4 candidate`);
