...
| constitution/08-event-model.md | 4.3 | In Review | Product Owner | 02-platform-invariants, 03-engineering-principles, 05-time-model, 06-identity-model, 07-module-taxonomy |
...
| ADR-010 | Draft | 2026-07-18 | Decision Time Model A + §2.6 Registry-Transition Policy = **Append-and-Revalidate** (PO quyết 2026-07-18, 4 guardrail + evidence chain). ADR chờ review + accept |
