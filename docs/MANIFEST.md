...
| constitution/07-module-taxonomy.md | 2.1 | In Review | Product Owner | 02-platform-invariants, 03-engineering-principles, 04-domain-principles |
| constitution/08-event-model.md | 1.4 | In Review | Product Owner | 05-time-model, 06-identity-model, 02-platform-invariants |
...
**Trạng thái tổng quát:** `In Review` cho Chapter 07-14, NHƯNG **Chapter 0, 1, 2, 3, 4, 5, 6 đã `Locked`** — cùng ADR-005, ADR-006, ADR-007, ADR-008. Từ giờ mọi thay đổi vào các file đã Locked bắt buộc qua ADR mới. Chapter 7 — Module Taxonomy là mục tiêu tiếp theo. Lưu ý: Chapter 8 (Event Model) KHÔNG được Lock khi OQ-005/OQ-006 còn Open. Xem [CHANGELOG.md](./CHANGELOG.md).
