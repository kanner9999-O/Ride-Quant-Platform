...
| constitution/10-compatibility-capability-contract.md | 2.1 | In Review | Product Owner | 02-platform-invariants, 03-engineering-principles, 04-domain-principles, 07-module-taxonomy, 08-event-model, 09-plugin-model |
