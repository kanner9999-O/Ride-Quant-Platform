...
Current milestone:        M3 — Context Projection / context-aggregator
                           ...
                           remains NOT IMPLEMENTED; next governed
                           action is fresh ChatGPT Review A re-review
                           of context.md v0.4.
                           M1
...
Current primary WP:       (none currently assigned) -- context-aggregator
                           ...
                           ADR-046), context.md v0.4 corrected Draft
                           candidate implementing ADR-046 pending fresh
                           Review A, Context Input Contract NOT
                           AUTHORED, runtime/publishing/Strategy
                           integration NOT IMPLEMENTED, next governed
                           action is fresh ChatGPT Review A re-review
                           of context.md v0.4), M4 QUEUED
