...
Current milestone:        M3 — Context Projection / context-aggregator
                           ...
                           is now CANDIDATE AUTHORED -- NOT PUBLISHED.
                           Next governed action is fresh ChatGPT
                           Review A of the Context Input Contract
                           candidate and its factual context.md
                           alignment, followed by Risk Classification
                           and next routing.
                           M1
...
Current primary WP:       (none currently assigned) -- context-aggregator
                           ...
                           (`CONTEXT-INPUT-CONTRACT-001`, this
                           transaction) -- M1 DONE, M2
                           ...
                           Draft), Context Input Contract CANDIDATE
                           AUTHORED -- NOT PUBLISHED, pending fresh
                           Review A, Context Event Contracts NOT
                           AUTHORED, runtime/publishing/Strategy
                           integration NOT IMPLEMENTED, next governed
                           action is fresh ChatGPT Review A of the
                           Context Input Contract candidate and its
                           factual context.md alignment, followed by
                           Risk Classification and next routing), M4
                           QUEUED
