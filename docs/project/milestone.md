...
Current milestone:        M3 — Context Projection / context-aggregator
                           ...
                           Structure effective-time interval; M3 NOT
                           DONE -- runtime/Input Contract/Event
...
Current primary WP:       (none currently assigned) -- context-aggregator
                           ...
                           Review A re-review. Prior Condition-1
                           ...
                           and bounded-corrected for 3 Review-A Majors
                           (`CONTEXT-AGGREGATOR-CORE-001-CORR-001`,
                           this transaction) -- M1 DONE, M2 BLOCKED
                           (parallel lane), M3 ACTIVE (Context
                           Projection / context-aggregator, core
                           implemented and corrected, runtime/
                           publishing/Strategy integration not
                           started), M4 QUEUED
