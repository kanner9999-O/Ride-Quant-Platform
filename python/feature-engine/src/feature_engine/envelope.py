...
redefine them. Duplicated (not imported) from structure-engine/
raw-regime-engine's own `envelope.py` — see `identity.py`'s module docstring
for why the three packages do not share code.
"""
