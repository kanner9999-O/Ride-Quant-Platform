...
package has with Chapter 8). Duplicated (not imported) from structure-engine's
own `envelope.py` — see `identity.py`'s module docstring for why the two
packages do not share code.
"""
